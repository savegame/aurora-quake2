...
bool ImGui_ImplOpenGL3_CreateFontsTexture()
{
    ...
    // AURORA: glGenTextures возвращает id внутри диапазона, который движок
    // Quake2 назначает себе сам (TEXNUM_IMAGES+, от 1024 вверх, БЕЗ
    // glGenTextures) — при загрузке карты игра заливала свою текстуру поверх
    // атласа шрифтов imgui и весь UI-оверлей ломался. Поэтому атласу даём
    // фиксированный id вне диапазона игры (игра: 1024..~3220).
    bd->FontTexture = AURORA_IMGUI_FONT_TEX_ID;
#else
